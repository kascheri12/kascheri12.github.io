...
Here's pseudo code for the functions:
  ...
  * [get_avg_subtasks_completed_on_date(list_nodes_on_date,distinct_timestamps_on_date)](https://github.com/kascheri12/golem_util/blob/prod/analyze_data.py#L597)
    * total_count_requested_subtasks = sum( requested_subtasks ) in list_nodes_on_date
